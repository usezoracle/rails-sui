...
func (m *PaymentOrderMutation) SetSuiReceiveAddressID(id int) {
	m.sui_receive_address = &id
}

// ClearSuiReceiveAddress clears the "sui_receive_address" edge to the SuiReceiveAddress entity.
func (m *PaymentOrderMutation) ClearSuiReceiveAddress() {
	m.clearedsui_receive_address = true
}

// SuiReceiveAddressCleared reports if the "sui_receive_address" edge to the SuiReceiveAddress entity was cleared.
func (m *PaymentOrderMutation) SuiReceiveAddressCleared() bool {
	return m.clearedsui_receive_address
}

// SuiReceiveAddressID returns the "sui_receive_address" edge ID in the mutation.
func (m *PaymentOrderMutation) SuiReceiveAddressID() (id int, exists bool) {
	if m.sui_receive_address != nil {
		return *m.sui_receive_address, true
	}
	return
}

// SuiReceiveAddressIDs returns the "sui_receive_address" edge IDs in the mutation.
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// SuiReceiveAddressID instead. It exists only for internal usage by the builders.
func (m *PaymentOrderMutation) SuiReceiveAddressIDs() (ids []int) {
...
// ResetSuiReceiveAddress resets all changes to the "sui_receive_address" edge.
func (m *PaymentOrderMutation) ResetSuiReceiveAddress() {
	m.sui_receive_address = nil
...
// SuiReceiveAddressMutation represents an operation that mutates the SuiReceiveAddress nodes in the graph.
type SuiReceiveAddressMutation struct {
	config
	op                   Op
	typ                  string
	id                   *int
	...
	addexpected_amount   *int64
	status               *suireceiveaddress.Status
	deposit_tx_digest    *string
	forward_tx_digest    *string
	valid_until          *time.Time
	clearedFields        map[string]struct{}
	payment_order        *uuid.UUID
	clearedpayment_order bool
	done                 bool
	oldValue             func(context.Context) (*SuiReceiveAddress, error)
	predicates           []predicate.SuiReceiveAddress
}

var _ ent.Mutation = (*SuiReceiveAddressMutation)(nil)

// suireceiveaddressOption allows management of the mutation configuration using functional options.
type suireceiveaddressOption func(*SuiReceiveAddressMutation)

// newSuiReceiveAddressMutation creates new mutation for the SuiReceiveAddress entity.
func newSuiReceiveAddressMutation(c config, op Op, opts ...suireceiveaddressOption) *SuiReceiveAddressMutation {
	m := &SuiReceiveAddressMutation{
		config:        c,
		op:            op,
		typ:           TypeSuiReceiveAddress,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withSuiReceiveAddressID sets the ID field of the mutation.
func withSuiReceiveAddressID(id int) suireceiveaddressOption {
	return func(m *SuiReceiveAddressMutation) {
		var (
			err   error
			once  sync.Once
			value *SuiReceiveAddress
		)
		m.oldValue = func(ctx context.Context) (*SuiReceiveAddress, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().SuiReceiveAddress.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withSuiReceiveAddress sets the old SuiReceiveAddress of the mutation.
func withSuiReceiveAddress(node *SuiReceiveAddress) suireceiveaddressOption {
	return func(m *SuiReceiveAddressMutation) {
		m.oldValue = func(context.Context) (*SuiReceiveAddress, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m SuiReceiveAddressMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m SuiReceiveAddressMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *SuiReceiveAddressMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *SuiReceiveAddressMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().SuiReceiveAddress.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetCreatedAt sets the "created_at" field.
func (m *SuiReceiveAddressMutation) SetCreatedAt(t time.Time) {
	m.created_at = &t
}

// CreatedAt returns the value of the "created_at" field in the mutation.
func (m *SuiReceiveAddressMutation) CreatedAt() (r time.Time, exists bool) {
	v := m.created_at
	if v == nil {
		return
	}
...
// OldCreatedAt returns the old "created_at" field's value of the SuiReceiveAddress entity.
// If the SuiReceiveAddress object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SuiReceiveAddressMutation) OldCreatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCreatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetCreatedAt resets all changes to the "created_at" field.
func (m *SuiReceiveAddressMutation) ResetCreatedAt() {
	m.created_at = nil
}

// SetUpdatedAt sets the "updated_at" field.
func (m *SuiReceiveAddressMutation) SetUpdatedAt(t time.Time) {
	m.updated_at = &t
}

// UpdatedAt returns the value of the "updated_at" field in the mutation.
func (m *SuiReceiveAddressMutation) UpdatedAt() (r time.Time, exists bool) {
	v := m.updated_at
	if v == nil {
		return
	}
...
// OldUpdatedAt returns the old "updated_at" field's value of the SuiReceiveAddress entity.
// If the SuiReceiveAddress object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SuiReceiveAddressMutation) OldUpdatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUpdatedAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetUpdatedAt resets all changes to the "updated_at" field.
func (m *SuiReceiveAddressMutation) ResetUpdatedAt() {
	m.updated_at = nil
}

// SetAddress sets the "address" field.
func (m *SuiReceiveAddressMutation) SetAddress(s string) {
	m.address = &s
}

// Address returns the value of the "address" field in the mutation.
func (m *SuiReceiveAddressMutation) Address() (r string, exists bool) {
	v := m.address
	if v == nil {
		return
	}
...
// OldAddress returns the old "address" field's value of the SuiReceiveAddress entity.
// If the SuiReceiveAddress object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SuiReceiveAddressMutation) OldAddress(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldAddress is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetAddress resets all changes to the "address" field.
func (m *SuiReceiveAddressMutation) ResetAddress() {
	m.address = nil
}

// SetEncryptedSeed sets the "encrypted_seed" field.
func (m *SuiReceiveAddressMutation) SetEncryptedSeed(b []byte) {
	m.encrypted_seed = &b
}

// EncryptedSeed returns the value of the "encrypted_seed" field in the mutation.
func (m *SuiReceiveAddressMutation) EncryptedSeed() (r []byte, exists bool) {
	v := m.encrypted_seed
	if v == nil {
		return
	}
...
// OldEncryptedSeed returns the old "encrypted_seed" field's value of the SuiReceiveAddress entity.
// If the SuiReceiveAddress object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SuiReceiveAddressMutation) OldEncryptedSeed(ctx context.Context) (v []byte, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *SuiReceiveAddressMutation) ResetEncryptedSeed() {
	m.encrypted_seed = nil
}

// SetCoinType sets the "coin_type" field.
func (m *SuiReceiveAddressMutation) SetCoinType(s string) {
	m.coin_type = &s
}

// CoinType returns the value of the "coin_type" field in the mutation.
func (m *SuiReceiveAddressMutation) CoinType() (r string, exists bool) {
	v := m.coin_type
	if v == nil {
		return
	}
...
// OldCoinType returns the old "coin_type" field's value of the SuiReceiveAddress entity.
// If the SuiReceiveAddress object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SuiReceiveAddressMutation) OldCoinType(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *SuiReceiveAddressMutation) ResetCoinType() {
	m.coin_type = nil
}

// SetExpectedAmount sets the "expected_amount" field.
func (m *SuiReceiveAddressMutation) SetExpectedAmount(u uint64) {
	m.expected_amount = &u
	m.addexpected_amount = nil
}

// ExpectedAmount returns the value of the "expected_amount" field in the mutation.
func (m *SuiReceiveAddressMutation) ExpectedAmount() (r uint64, exists bool) {
	v := m.expected_amount
	if v == nil {
		return
	}
...
// OldExpectedAmount returns the old "expected_amount" field's value of the SuiReceiveAddress entity.
// If the SuiReceiveAddress object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SuiReceiveAddressMutation) OldExpectedAmount(ctx context.Context) (v uint64, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *SuiReceiveAddressMutation) AddExpectedAmount(u int64) {
	if m.addexpected_amount != nil {
		*m.addexpected_amount += u
	} else {
		m.addexpected_amount = &u
	}
}

// AddedExpectedAmount returns the value that was added to the "expected_amount" field in this mutation.
func (m *SuiReceiveAddressMutation) AddedExpectedAmount() (r int64, exists bool) {
	v := m.addexpected_amount
	if v == nil {
		return
	}
	return *v, true
...
func (m *SuiReceiveAddressMutation) ResetExpectedAmount() {
	m.expected_amount = nil
	m.addexpected_amount = nil
}

// SetStatus sets the "status" field.
func (m *SuiReceiveAddressMutation) SetStatus(s suireceiveaddress.Status) {
	m.status = &s
}

// Status returns the value of the "status" field in the mutation.
func (m *SuiReceiveAddressMutation) Status() (r suireceiveaddress.Status, exists bool) {
	v := m.status
	if v == nil {
		return
	}
...
// OldStatus returns the old "status" field's value of the SuiReceiveAddress entity.
// If the SuiReceiveAddress object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SuiReceiveAddressMutation) OldStatus(ctx context.Context) (v suireceiveaddress.Status, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldStatus is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetStatus resets all changes to the "status" field.
func (m *SuiReceiveAddressMutation) ResetStatus() {
	m.status = nil
}

// SetDepositTxDigest sets the "deposit_tx_digest" field.
func (m *SuiReceiveAddressMutation) SetDepositTxDigest(s string) {
	m.deposit_tx_digest = &s
}

// DepositTxDigest returns the value of the "deposit_tx_digest" field in the mutation.
func (m *SuiReceiveAddressMutation) DepositTxDigest() (r string, exists bool) {
	v := m.deposit_tx_digest
	if v == nil {
		return
	}
	return *v, true
...
// OldDepositTxDigest returns the old "deposit_tx_digest" field's value of the SuiReceiveAddress entity.
// If the SuiReceiveAddress object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SuiReceiveAddressMutation) OldDepositTxDigest(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldDepositTxDigest is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldDepositTxDigest requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldDepositTxDigest: %w", err)
	}
	return oldValue.DepositTxDigest, nil
}

// ClearDepositTxDigest clears the value of the "deposit_tx_digest" field.
func (m *SuiReceiveAddressMutation) ClearDepositTxDigest() {
	m.deposit_tx_digest = nil
	m.clearedFields[suireceiveaddress.FieldDepositTxDigest] = struct{}{}
}

// DepositTxDigestCleared returns if the "deposit_tx_digest" field was cleared in this mutation.
func (m *SuiReceiveAddressMutation) DepositTxDigestCleared() bool {
	_, ok := m.clearedFields[suireceiveaddress.FieldDepositTxDigest]
	return ok
}

// ResetDepositTxDigest resets all changes to the "deposit_tx_digest" field.
func (m *SuiReceiveAddressMutation) ResetDepositTxDigest() {
	m.deposit_tx_digest = nil
	delete(m.clearedFields, suireceiveaddress.FieldDepositTxDigest)
}

// SetForwardTxDigest sets the "forward_tx_digest" field.
func (m *SuiReceiveAddressMutation) SetForwardTxDigest(s string) {
	m.forward_tx_digest = &s
}

// ForwardTxDigest returns the value of the "forward_tx_digest" field in the mutation.
func (m *SuiReceiveAddressMutation) ForwardTxDigest() (r string, exists bool) {
	v := m.forward_tx_digest
	if v == nil {
		return
	}
	return *v, true
...
// OldForwardTxDigest returns the old "forward_tx_digest" field's value of the SuiReceiveAddress entity.
// If the SuiReceiveAddress object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SuiReceiveAddressMutation) OldForwardTxDigest(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldForwardTxDigest is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldForwardTxDigest requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldForwardTxDigest: %w", err)
	}
	return oldValue.ForwardTxDigest, nil
}

// ClearForwardTxDigest clears the value of the "forward_tx_digest" field.
func (m *SuiReceiveAddressMutation) ClearForwardTxDigest() {
	m.forward_tx_digest = nil
	m.clearedFields[suireceiveaddress.FieldForwardTxDigest] = struct{}{}
}

// ForwardTxDigestCleared returns if the "forward_tx_digest" field was cleared in this mutation.
func (m *SuiReceiveAddressMutation) ForwardTxDigestCleared() bool {
	_, ok := m.clearedFields[suireceiveaddress.FieldForwardTxDigest]
	return ok
}

// ResetForwardTxDigest resets all changes to the "forward_tx_digest" field.
func (m *SuiReceiveAddressMutation) ResetForwardTxDigest() {
	m.forward_tx_digest = nil
	delete(m.clearedFields, suireceiveaddress.FieldForwardTxDigest)
}

// SetValidUntil sets the "valid_until" field.
func (m *SuiReceiveAddressMutation) SetValidUntil(t time.Time) {
	m.valid_until = &t
}

// ValidUntil returns the value of the "valid_until" field in the mutation.
func (m *SuiReceiveAddressMutation) ValidUntil() (r time.Time, exists bool) {
	v := m.valid_until
	if v == nil {
		return
	}
...
// OldValidUntil returns the old "valid_until" field's value of the SuiReceiveAddress entity.
// If the SuiReceiveAddress object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SuiReceiveAddressMutation) OldValidUntil(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldValidUntil is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetValidUntil resets all changes to the "valid_until" field.
func (m *SuiReceiveAddressMutation) ResetValidUntil() {
	m.valid_until = nil
}

// SetPaymentOrderID sets the "payment_order" edge to the PaymentOrder entity by id.
func (m *SuiReceiveAddressMutation) SetPaymentOrderID(id uuid.UUID) {
	m.payment_order = &id
}

// ClearPaymentOrder clears the "payment_order" edge to the PaymentOrder entity.
func (m *SuiReceiveAddressMutation) ClearPaymentOrder() {
	m.clearedpayment_order = true
}

// PaymentOrderCleared reports if the "payment_order" edge to the PaymentOrder entity was cleared.
func (m *SuiReceiveAddressMutation) PaymentOrderCleared() bool {
	return m.clearedpayment_order
}

// PaymentOrderID returns the "payment_order" edge ID in the mutation.
func (m *SuiReceiveAddressMutation) PaymentOrderID() (id uuid.UUID, exists bool) {
	if m.payment_order != nil {
		return *m.payment_order, true
	}
	return
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// PaymentOrderID instead. It exists only for internal usage by the builders.
func (m *SuiReceiveAddressMutation) PaymentOrderIDs() (ids []uuid.UUID) {
	if id := m.payment_order; id != nil {
		ids = append(ids, *id)
	}
	return
...
// ResetPaymentOrder resets all changes to the "payment_order" edge.
func (m *SuiReceiveAddressMutation) ResetPaymentOrder() {
	m.payment_order = nil
	m.clearedpayment_order = false
}

// Where appends a list predicates to the SuiReceiveAddressMutation builder.
func (m *SuiReceiveAddressMutation) Where(ps ...predicate.SuiReceiveAddress) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the SuiReceiveAddressMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *SuiReceiveAddressMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.SuiReceiveAddress, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *SuiReceiveAddressMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *SuiReceiveAddressMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (SuiReceiveAddress).
func (m *SuiReceiveAddressMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *SuiReceiveAddressMutation) Fields() []string {
	fields := make([]string, 0, 10)
	if m.created_at != nil {
		fields = append(fields, suireceiveaddress.FieldCreatedAt)
	}
	if m.updated_at != nil {
		fields = append(fields, suireceiveaddress.FieldUpdatedAt)
	}
	if m.address != nil {
		fields = append(fields, suireceiveaddress.FieldAddress)
	}
	if m.encrypted_seed != nil {
		fields = append(fields, suireceiveaddress.FieldEncryptedSeed)
	}
	if m.coin_type != nil {
		fields = append(fields, suireceiveaddress.FieldCoinType)
	}
	if m.expected_amount != nil {
		fields = append(fields, suireceiveaddress.FieldExpectedAmount)
	}
	if m.status != nil {
		fields = append(fields, suireceiveaddress.FieldStatus)
	}
	if m.deposit_tx_digest != nil {
		fields = append(fields, suireceiveaddress.FieldDepositTxDigest)
	}
	if m.forward_tx_digest != nil {
		fields = append(fields, suireceiveaddress.FieldForwardTxDigest)
	}
	if m.valid_until != nil {
		fields = append(fields, suireceiveaddress.FieldValidUntil)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *SuiReceiveAddressMutation) Field(name string) (ent.Value, bool) {
	switch name {
	...
	case suireceiveaddress.FieldDepositTxDigest:
		return m.DepositTxDigest()
	case suireceiveaddress.FieldForwardTxDigest:
		return m.ForwardTxDigest()
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *SuiReceiveAddressMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case suireceiveaddress.FieldCreatedAt:
		return m.OldCreatedAt(ctx)
	case suireceiveaddress.FieldUpdatedAt:
	...
	case suireceiveaddress.FieldStatus:
		return m.OldStatus(ctx)
	case suireceiveaddress.FieldDepositTxDigest:
		return m.OldDepositTxDigest(ctx)
	case suireceiveaddress.FieldForwardTxDigest:
		return m.OldForwardTxDigest(ctx)
	case suireceiveaddress.FieldValidUntil:
		return m.OldValidUntil(ctx)
	}
	return nil, fmt.Errorf("unknown SuiReceiveAddress field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *SuiReceiveAddressMutation) SetField(name string, value ent.Value) error {
	switch name {
	case suireceiveaddress.FieldCreatedAt:
		v, ok := value.(time.Time)
		if !ok {
	...
	case suireceiveaddress.FieldExpectedAmount:
		...
		return nil
	case suireceiveaddress.FieldStatus:
		v, ok := value.(suireceiveaddress.Status)
		if !ok {
			return fmt.Errorf("unexpected type %T for field %s", value, name)
		}
		m.SetStatus(v)
	...
	return fmt.Errorf("unknown SuiReceiveAddress field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *SuiReceiveAddressMutation) AddedFields() []string {
	var fields []string
	if m.addexpected_amount != nil {
		fields = append(fields, suireceiveaddress.FieldExpectedAmount)
	}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *SuiReceiveAddressMutation) AddedField(name string) (ent.Value, bool) {
	switch name {
	case suireceiveaddress.FieldExpectedAmount:
		return m.AddedExpectedAmount()
	}
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *SuiReceiveAddressMutation) AddField(name string, value ent.Value) error {
	switch name {
	case suireceiveaddress.FieldExpectedAmount:
		v, ok := value.(int64)
		if !ok {
		...
		m.AddExpectedAmount(v)
		return nil
	}
	return fmt.Errorf("unknown SuiReceiveAddress numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *SuiReceiveAddressMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(suireceiveaddress.FieldDepositTxDigest) {
		fields = append(fields, suireceiveaddress.FieldDepositTxDigest)
	}
	if m.FieldCleared(suireceiveaddress.FieldForwardTxDigest) {
		fields = append(fields, suireceiveaddress.FieldForwardTxDigest)
	}
	return fields
}
...
// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *SuiReceiveAddressMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *SuiReceiveAddressMutation) ClearField(name string) error {
	switch name {
	case suireceiveaddress.FieldDepositTxDigest:
		m.ClearDepositTxDigest()
		return nil
	case suireceiveaddress.FieldForwardTxDigest:
		m.ClearForwardTxDigest()
		return nil
	}
	return fmt.Errorf("unknown SuiReceiveAddress nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *SuiReceiveAddressMutation) ResetField(name string) error {
	switch name {
	case suireceiveaddress.FieldCreatedAt:
		m.ResetCreatedAt()
		return nil
	...
	case suireceiveaddress.FieldStatus:
		...
		return nil
	case suireceiveaddress.FieldDepositTxDigest:
		m.ResetDepositTxDigest()
		return nil
	case suireceiveaddress.FieldForwardTxDigest:
		m.ResetForwardTxDigest()
		return nil
	case suireceiveaddress.FieldValidUntil:
		m.ResetValidUntil()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *SuiReceiveAddressMutation) AddedEdges() []string {
	edges := make([]string, 0, 1)
	if m.payment_order != nil {
		edges = append(edges, suireceiveaddress.EdgePaymentOrder)
	}
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *SuiReceiveAddressMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case suireceiveaddress.EdgePaymentOrder:
		if id := m.payment_order; id != nil {
			return []ent.Value{*id}
		}
	}
...
// RemovedEdges returns all edge names that were removed in this mutation.
func (m *SuiReceiveAddressMutation) RemovedEdges() []string {
	edges := make([]string, 0, 1)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *SuiReceiveAddressMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *SuiReceiveAddressMutation) ClearedEdges() []string {
	edges := make([]string, 0, 1)
	if m.clearedpayment_order {
		edges = append(edges, suireceiveaddress.EdgePaymentOrder)
	}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *SuiReceiveAddressMutation) EdgeCleared(name string) bool {
	switch name {
	case suireceiveaddress.EdgePaymentOrder:
		return m.clearedpayment_order
	}
...
// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *SuiReceiveAddressMutation) ClearEdge(name string) error {
	switch name {
	case suireceiveaddress.EdgePaymentOrder:
		m.ClearPaymentOrder()
		return nil
	}
	return fmt.Errorf("unknown SuiReceiveAddress unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *SuiReceiveAddressMutation) ResetEdge(name string) error {
	switch name {
	case suireceiveaddress.EdgePaymentOrder:
		m.ResetPaymentOrder()
		return nil
