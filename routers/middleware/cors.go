...
func CORSMiddleware() gin.HandlerFunc {
	return func(ctx *gin.Context) {
		...
		ctx.Writer.Header().Set("Access-Control-Allow-Headers", "Origin, Content-Type, api_key, Content-Length, Accept-Encoding, X-CSRF-Token, Authorization, Client-Type, X-Admin-Token, ngrok-skip-browser-warning")
